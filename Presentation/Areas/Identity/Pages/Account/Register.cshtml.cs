...
namespace Web_ECommerce.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(50, ErrorMessage = "A senha deve ter no mínimo {2} caracteres.", MinimumLength = 8)]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirme seu email",
                        $"Por favor, confirme sua conta por <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Aqui</a>.");
